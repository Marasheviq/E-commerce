...
<body>
    <div class="form-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Insert new customer if they don't already exist
            ...
            // Proceed with the order after customer registration
            $productId = 5; // Product ID (can be dynamic)
            $productPrice = 1039.99; // Product price
            ...
            if (mysqli_stmt_execute($stmt)) {
                echo "<p class='message' style='color: green;'>Product purchased successfully.</p>";
            } else {
