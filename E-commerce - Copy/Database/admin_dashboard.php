...
$db_user = "root";
$db_pass = "";
$db_name = "Ecommerce"; // Correct database name
...
// Fetch all orders in descending order
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['delete_customer'])) {
        // Delete related orders and comments first
        ...
        // Delete comments associated with the customer
